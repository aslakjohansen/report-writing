...
\begin{inspiration}{Jane Goodall\idx{Jane Goodall}\cite{goodall1974}}
  ``
...
\begin{inspiration}{Lao Tzu (老子)\idx{Lao Tzu (老子)}\cite{TaoTeChing400BC}}
  ``
...
\begin{inspiration}{Stephen King\idx{Stephen King}\cite{king2000writing}}
  ``
    \textsl{To write is human, to edit is divine.}
  ''
\end{inspiration}
\begin{inspiration}{David McCullough\idx{David McCullough}\cite{McCullough2002}}
  ``
...
\begin{enumerate}
  ...
  \descitem{Respect your Audience} \idx{Audience}
    ...
    \begin{inspiration}[0.82]{Rupert Giles\idx{Rupert Giles}\cite{buffy_s1e8}}
  ``
...
\begin{inspiration}{Isaac Newton\idx{Isaac Newton}\cite{Solr-dc-9792}}
  ``
...
\begin{inspiration}{Xander Harris\idx{Xander Harris}\cite{buffy_s7e4}}
  ``
...
\begin{inspiration}{Donald Knuth\idx{Donald Knuth}\cite{knuth74ComputerProgrammingasanArt}}
  ``
...
\begin{inspiration}{Donald Knuth\idx{Donald Knuth}\cite{knuth1977notes}}
  ``
...
\begin{inspiration}{Brian Kernighan\idx{Brian Kernighan}\cite{Kernighan1976SoftwareTools}}
  ``
...
\begin{inspiration}{John F. Woods\idx{John F. Woods}\cite{woods_1991}}
  ``
...
\begin{inspiration}{Larry Wall\idx{Larry Wall}\cite{linearscans1992}}
  ``
