...
\begin{itemize}
  ...
  \descitem{Word}\idxx{Microsoft!Word}{Microsoft Word} has a function that allows you to upload an audio file, and then it will generate a timestamped transcription. Furthermore, it can detect unique voices that you can name.
\end{itemize}
