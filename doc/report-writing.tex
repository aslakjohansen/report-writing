...
The title is also an opportunity to market yourselves. If you let it, it will stick out on your diploma. You can use it to brand yourselves to future employers. One way of doing so is to namedrop a few keywords. If you see yourself working with big data in the future, then choose a title that will use words associated with this.
