...
% glossary
As you, throughout the project, encounter domain specific abbreviations, make sure to add them to a glossary\idx{Glossary}. That way, you yourselves can rely on it throughout the remainder of the project, and you won't have to consider whether to do it poorly at the end.
...
% defense sequence: overview, presentation split, indicators for who did what, cycle through group members individually, grade handover at the end
