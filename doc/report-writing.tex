...
The project starts out with a well-defined goal. Throughout the project, work is directed towards this goal, and on the way material and experiences are produced.
...
Even when the work behind this has been well directed, some will end up as dead ends. You may also realize that the original problem is more complex than first anticipated and that not all the outcomes fit into a consistent whole. The purpose of the report is to capture a subset of these experiences that represent one -- or more -- units of knowledge that can be represented in an easily accessible way. The report tells the story of these units of knowledge.
