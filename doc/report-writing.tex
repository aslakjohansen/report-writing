...
This learning objective covers the ability to document work, disseminate knowledge and present verifiable arguments. All are essential for writing a good report. In order to evaluate this, we -- among others -- look at (i) readability, (ii) the density of relevant information, and (iii) the arguments behind the decisions made. It is your job to come up with verifiable arguments for your choices, and the job of the censor and advisor to verify these steps. If something is vaguely defined then it is likely to be impossible to construct solid arguments around.
