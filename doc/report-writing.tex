...
\begin{figure}[tbp]
  \begin{center}
    \begin{tikzpicture}
      ...
      {
        {
          \node[nodeAspectI] (n1) at (0,0) {};
          
          \node[nodeAspectI] (n11) at ([yshift= 1.5*\yspacing, xshift=\xspacing] n1) {};
          \node[nodeAspectI] (n12) at ([yshift= 0.5*\yspacing, xshift=\xspacing] n1) {};
          \node[nodeAspectI] (n13) at ([yshift=-0.5*\yspacing, xshift=\xspacing] n1) {};
          \node[nodeAspectI] (n14) at ([yshift=-1.5*\yspacing, xshift=\xspacing] n1) {};
          ...
          \node[nodeAspectI] (n142) at ([yshift= 0.5*\yspacing, xshift=\xspacing] n14) {};
          \node[nodeAspectI] (n143) at ([yshift=-0.5*\yspacing, xshift=\xspacing] n14) {};
          \node[nodeAspectI] (n144) at ([yshift=-1.5*\yspacing, xshift=\xspacing] n14) {};
          ...
          \node[nodeAspectI] (n1412) at ([yshift= 0*\yspacing, xshift=\xspacing] n141) {};
          \node[nodeAspectI] (n1413) at ([yshift=-1*\yspacing, xshift=\xspacing] n141) {};
          \node[nodeAspectI] (n1441) at ([yshift= 0.5*\yspacing, xshift=\xspacing] n144) {};
          \node[nodeAspectI] (n1442) at ([yshift=-0.5*\yspacing, xshift=\xspacing] n144) {};
        ...
        {
          \node[nodeAspectII] (n221) at ([yshift=-2.5*\yspacing, xshift=0] n1442) {};
          \node[nodeAspectII] (n222) at ([yshift=-3.5*\yspacing, xshift=0] n1442) {};
          
          \node[nodeAspectII] (n22) at ([yshift=-0.5*\yspacing, xshift=-\xspacing] n221) {};
          \node[nodeAspectII] (n21) at ([yshift= 1*\yspacing, xshift=0] n22) {};
          \node[nodeAspectII] (n23) at ([yshift=-1*\yspacing, xshift=0] n22) {};
          \draw[edgeAspectII] (n22) to [out=0,in=180] (n221);
          \draw[edgeAspectII] (n22) to [out=0,in=180] (n222);
          
          \node[nodeAspectII] (n2) at ([yshift=0, xshift=-\xspacing] n22) {};
        ...
        % merged graph
        {
          ...
          \node[nodeAspectsCombinedI] (m1n2) at ([yshift=-1*\yspacing, xshift=\xspacing] m1) {};
          \node[nodeAspectsCombinedI] (m2n1) at ([yshift= 1*\yspacing, xshift=\xspacing] m2) {};
          ...
          \node[nodeAspectsCombinedI] (m1n11) at ([yshift= 0.5*\yspacing, xshift=\xspacing] m1n1) {};
          ...
          \node[nodeAspectsCombinedI] (m2n11) at ([yshift= 0.5*\yspacing, xshift=\xspacing] m2n1) {};
          \node[nodeAspectsCombinedI] (m2n12) at ([yshift=-0.5*\yspacing, xshift=\xspacing] m2n1) {};
          \draw[edgeAspectsCombinedI] (m2n1) to [out=0,in=180] (m2n11);
          \draw[edgeAspectsCombinedI] (m2n1) to [out=0,in=180] (m2n12);
          
          \node[nodeAspectsCombinedI] (m2n21) at ([yshift= 0.5*\yspacing, xshift=\xspacing] m2n2) {};
          \node[nodeAspectsCombinedI] (m2n22) at ([yshift=-0.5*\yspacing, xshift=\xspacing] m2n2) {};
        ...
        
        {
          ...
          \node[nodeAspectsCombinedII] (l1n1) at ([yshift=0, xshift=\xspacing] l1) {};
