...
% the goal in the report is to capture a subset of these experiences that represent one -- or more -- units of knowledge that can be represented in a easily accessible way, the report tells the story behind these units of knowledge
