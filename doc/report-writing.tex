  ...
  \begin{center}
    \begin{tikzpicture}[remember picture]
      ...
      % left nodes
      {
        ...
        \node[process] (related) at (\xoffset+\xspacing*0, \yoffset+\yspacing*6) {};
        \node[anchor=east] (_) at ([xshift=-1.0-4mm]related) {\textsl{review litterature}};
        \draw (\xoffset+\xspacing*0, \yoffset+\yspacing*7) pic{file={0.3,Related Work}};
        \node[process] (analysis) at (\xoffset+\xspacing*0, \yoffset+\yspacing*8) {};
        \node[anchor=east] (_) at ([xshift=-1.0-4mm]analysis) {\textsl{analyze}};
        \draw (\xoffset+\xspacing*0, \yoffset+\yspacing*9) pic{file={0.3,Analysis}};
        \node[process] (design) at (\xoffset+\xspacing*0, \yoffset+\yspacing*10) {};
        \node[anchor=east] (_) at ([xshift=-1.0-4mm]design) {\textsl{derive design}};
        \draw (\xoffset+\xspacing*0, \yoffset+\yspacing*11) pic{file={0.3,Design}};
        \node[process] (impl) at (\xoffset+\xspacing*0, \yoffset+\yspacing*12) {};
        \node[anchor=east] (_) at ([xshift=-1.0-4mm]impl) {\textsl{implement}};
        \draw (\xoffset+\xspacing*0, \yoffset+\yspacing*13) pic{file={0.3,Implementation}};
        \node[process] (eval) at (\xoffset+\xspacing*0, \yoffset+\yspacing*14) {};
        \node[anchor=east] (_) at ([xshift=-1.0-4mm]eval) {\textsl{evaluate}};
        \draw (\xoffset+\xspacing*0, \yoffset+\yspacing*15) pic{file={0.3,Evaluation Results}};
        \node[process] (discuss) at (\xoffset+\xspacing*0, \yoffset+\yspacing*16) {};
        \node[anchor=east] (_) at ([xshift=-1.0-4mm]discuss) {\textsl{analyse results}};
        \draw (\xoffset+\xspacing*0, \yoffset+\yspacing*17) pic{file={0.3,Discussion}};
        \node[process] (future) at (\xoffset+\xspacing*0, \yoffset+\yspacing*18) {};
        \node[anchor=east] (_) at ([xshift=-1.0-4mm]future) {\textsl{plan}};
        \draw (\xoffset+\xspacing*0, \yoffset+\yspacing*19) pic{file={0.3,Future Work}};
        \node[process] (hindsight) at (\xoffset+\xspacing*0, \yoffset+\yspacing*20) {};
        \node[anchor=east] (_) at ([xshift=-1.0-4mm]hindsight) {\textsl{reflect}};
        \draw (\xoffset+\xspacing*0, \yoffset+\yspacing*21) pic{file={0.3,Hindsight}};
        \node[process] (conclusion) at (\xoffset+\xspacing*0, \yoffset+\yspacing*22) {};
        \node[anchor=east] (_) at ([xshift=-1.0-4mm]conclusion) {\textsl{conclude}};
        \draw (\xoffset+\xspacing*0, \yoffset+\yspacing*23) pic{file={0.3,Conclusion}};
      }
      ...
      % left edges
      {
        ...
        \draw[edge]               (\xoffset+\xspacing*0, \yoffset+\yspacing*5-3mm) -- (related);
        
        \draw[edge] (related) -- (\xoffset+\xspacing*0, \yoffset+\yspacing*7+3mm);
        \draw[edge]              (\xoffset+\xspacing*0, \yoffset+\yspacing*7-3mm) -- (analysis);
        
        \draw[edge] (analysis) -- (\xoffset+\xspacing*0, \yoffset+\yspacing*9+3mm);
        \draw[edge]               (\xoffset+\xspacing*0, \yoffset+\yspacing*9-3mm) -- (design);
        
        \draw[edge] (design) -- (\xoffset+\xspacing*0, \yoffset+\yspacing*11+3mm);
        \draw[edge]             (\xoffset+\xspacing*0, \yoffset+\yspacing*11-3mm) -- (impl);
        
        \draw[edge] (impl) -- (\xoffset+\xspacing*0, \yoffset+\yspacing*13+3mm);
        \draw[edge]           (\xoffset+\xspacing*0, \yoffset+\yspacing*13-3mm) -- (eval);
        
        \draw[edge] (eval) -- (\xoffset+\xspacing*0, \yoffset+\yspacing*15+3mm);
        \draw[edge]           (\xoffset+\xspacing*0, \yoffset+\yspacing*15-3mm) -- (discuss);
        
        \draw[edge] (discuss) -- (\xoffset+\xspacing*0, \yoffset+\yspacing*17+3mm);
        \draw[edge]              (\xoffset+\xspacing*0, \yoffset+\yspacing*17-3mm) -- (future);
        
        \draw[edge] (future) -- (\xoffset+\xspacing*0, \yoffset+\yspacing*19+3mm);
        \draw[edge]             (\xoffset+\xspacing*0, \yoffset+\yspacing*19-3mm) -- (hindsight);
        
        \draw[edge] (hindsight) -- (\xoffset+\xspacing*0, \yoffset+\yspacing*21+3mm);
        \draw[edge]                (\xoffset+\xspacing*0, \yoffset+\yspacing*21-3mm) -- (conclusion);
        
        \draw[edge] (conclusion) -- (\xoffset+\xspacing*0, \yoffset+\yspacing*23+3mm);
      }
