...
% the 40 ects trap: it ts common to be delayed after the first semester, still a 40ects project, effort split into conscious and subconscious, a deficiency of conscious effort can be overcome by increasing the effort (5ects can be split over a semester by working 1/6 harder), a subconscious deficiency can only be countered by adding time, if you find yourself in this situation then you have lost the main benefit of going 40 ects, an extension can't fix this as that means that you have to do additional work
