...
\index{Directed Acyclic Graph|see {DAG}}
\index{Datalogi|see {Computer science}}
\index{Mean time between failures|see {MTBF}}
\index{Mean time between repair|see {MTBR}}
