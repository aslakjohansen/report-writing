...
\begin{inspiration}{Jane Goodall\cite{goodall1974}}
  ``
...
\begin{inspiration}{Lao Tzu (老子)\cite{TaoTeChing400BC}}
  ``
...
\begin{inspiration}{ Stephen King\cite{king2000writing}}
  ``
    \textsl{To write is human, to edit is divine.}
  ''
\end{inspiration}
\begin{inspiration}{David McCullough\cite{McCullough2002}}
  ``
...
\begin{enumerate}
  ...
  \descitem{Respect your Audience} \idx{Audience}
    ...
    \begin{inspiration}[0.82]{Rupert Giles\cite{buffy_s1e8}}
  ``
...
\begin{inspiration}{Larry Wall\cite{linearscans1992}}
  ``
