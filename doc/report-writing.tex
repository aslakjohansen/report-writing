...
Throughout the project you will have a workflow\idx{Workflow}, that typically consists of a series of processes each resulting in a work product. A typical workflow is illustrated in figure \ref{fig:first:overview} along with an illustration of how each part of this flow is normally mapped to a section. Do note that the \textsl{right} workflow (and structure) depends on the nature of the project. In particular, a project that is \textsl{explorative}\idx{Explorative project} in nature will likely look significantly different.
