...
\begin{figure}[tbp]
  \begin{center}
    ...
    \end{tikzpicture}
  \end{center}
  \caption[Pruning the coverage DAG]{Pruning the coverage DAG. Filled nodes represent dead ends.}
...
\begin{inspiration}{Xander Harris\cite{buffy_s7e4}}
  Figuring out how to control your magic seems a lot like hammering a nail. At the end of the hammer, you have the power, but no control. It takes, like, two strokes to hit the nail in, or you could hit your thumb.
