...
\begin{figure}[tbp]
  \begin{center}
      ...
      {
        {
          ...
          \node[node] (n11) at ([yshift= 1.5*\yspacing, xshift=\xspacing] n1) {};
          \node[node] (n12) at ([yshift= 0.5*\yspacing, xshift=\xspacing] n1) {};
          \node[node] (n13) at ([yshift=-0.5*\yspacing, xshift=\xspacing] n1) {};
          \node[node] (n14) at ([yshift=-1.5*\yspacing, xshift=\xspacing] n1) {};
          \draw[edge] (n1) to [out=0,in=180] (n11);
          \draw[edge] (n1) to [out=0,in=180] (n12);
          \draw[edge] (n1) to [out=0,in=180] (n13);
          \draw[edge] (n1) to [out=0,in=180] (n14);
          
          \node[node] (n141) at ([yshift= 1.5*\yspacing, xshift=\xspacing] n14) {};
          \node[node] (n142) at ([yshift= 0.5*\yspacing, xshift=\xspacing] n14) {};
          \node[node] (n143) at ([yshift=-0.5*\yspacing, xshift=\xspacing] n14) {};
          \node[node] (n144) at ([yshift=-1.5*\yspacing, xshift=\xspacing] n14) {};
          \draw[edge] (n14) to [out=0,in=180] (n141);
          \draw[edge] (n14) to [out=0,in=180] (n142);
          \draw[edge] (n14) to [out=0,in=180] (n143);
          \draw[edge] (n14) to [out=0,in=180] (n144);
          
          \node[node] (n1411) at ([yshift= 1*\yspacing, xshift=\xspacing] n141) {};
          \node[node] (n1412) at ([yshift= 0*\yspacing, xshift=\xspacing] n141) {};
          \node[node] (n1413) at ([yshift=-1*\yspacing, xshift=\xspacing] n141) {};
          \node[node] (n1441) at ([yshift= 0.5*\yspacing, xshift=\xspacing] n144) {};
          \node[node] (n1442) at ([yshift=-0.5*\yspacing, xshift=\xspacing] n144) {};
          \draw[edge] (n141) to [out=0,in=180] (n1411);
          \draw[edge] (n141) to [out=0,in=180] (n1412);
          \draw[edge] (n141) to [out=0,in=180] (n1413);
          \draw[edge] (n144) to [out=0,in=180] (n1441);
          \draw[edge] (n144) to [out=0,in=180] (n1442);
        }
        
        {
          \node[node] (n221) at ([yshift=-2.5*\yspacing, xshift=0] n1442) {};
          \node[node] (n222) at ([yshift=-3.5*\yspacing, xshift=0] n1442) {};
          
          \node[node] (n22) at ([yshift=-0.5*\yspacing, xshift=-\xspacing] n221) {};
          \node[node] (n21) at ([yshift= 1*\yspacing, xshift=0] n22) {};
          \node[node] (n23) at ([yshift=-1*\yspacing, xshift=0] n22) {};
          \draw[edge] (n22) to [out=0,in=180] (n221);
          \draw[edge] (n22) to [out=0,in=180] (n222);
          
          \node[node] (n2) at ([yshift=0, xshift=-\xspacing] n22) {};
          \draw[edge] (n2) to [out=0,in=180] (n21);
          \draw[edge] (n2) to [out=0,in=180] (n22);
          \draw[edge] (n2) to [out=0,in=180] (n23);
        }
        ...
        % merged graph
        {
          ...
          \node[node] (m1n1) at ([yshift= 1*\yspacing, xshift=\xspacing] m1) {};
          \node[node] (m1n2) at ([yshift=-1*\yspacing, xshift=\xspacing] m1) {};
          \node[node] (m2n1) at ([yshift= 1*\yspacing, xshift=\xspacing] m2) {};
          \node[node] (m2n2) at ([yshift=-1*\yspacing, xshift=\xspacing] m2) {};
          ...
          \node[node] (m1n11) at ([yshift= 0.5*\yspacing, xshift=\xspacing] m1n1) {};
          \node[node] (m1n12) at ([yshift=-0.5*\yspacing, xshift=\xspacing] m1n1) {};
          \draw[edge] (m1n1) to [out=0,in=180] (m1n11);
          \draw[edge] (m1n1) to [out=0,in=180] (m1n12);
          
          \node[node] (m2n11) at ([yshift= 0.5*\yspacing, xshift=\xspacing] m2n1) {};
          \node[node] (m2n12) at ([yshift=-0.5*\yspacing, xshift=\xspacing] m2n1) {};
          \draw[edge] (m2n1) to [out=0,in=180] (m2n11);
          \draw[edge] (m2n1) to [out=0,in=180] (m2n12);
          
          \node[node] (m2n21) at ([yshift= 0.5*\yspacing, xshift=\xspacing] m2n2) {};
          \node[node] (m2n22) at ([yshift=-0.5*\yspacing, xshift=\xspacing] m2n2) {};
          \draw[edge] (m2n2) to [out=0,in=180] (m2n21);
          \draw[edge] (m2n2) to [out=0,in=180] (m2n22);
        }
        
        {
          \coordinate (l1) at ($(m1n12)!0.5!(m2n12)$);
          \node[node] (l1n1) at ([yshift=0, xshift=\xspacing] l1) {};
    ...
    \end{tikzpicture}
  \end{center}
  \caption{Pruning the coverage tree.}
