...
Simply reading a large number of papers does not build trust in the result.
...
% proposed structure: follow the questions, if few papers then one per paragraph

% if many papers then write a text presenting the space in a structured manner, add references to the papers collaborating each point, quotes can be added.
