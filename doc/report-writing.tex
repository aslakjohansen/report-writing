...
\scalebox{0}{
  ...
  \textcolor{white}{\index{Don Knuth|see {Donald Knuth}}}
    ...
    \centering
      \scalebox{0.7}{
        \begin{tikzpicture}[x=1cm, y=-1cm, node distance=0 cm,outer sep = 0pt]
          ...
          % front page
          \node[nodet] (first) at ([xshift=\spacing] origo) {(\textsl{\$num})};
          \node[nodet] (ftext) at ([xshift=\spacing] first.east) {\textsl{\$text}};
          \node[nodet] (last) at ([xshift=\spacing*1.5] ftext.east) {, and (\textsl{\$num})};
          \node[nodet] (ltext) at ([xshift=\spacing] last.east) {\textsl{\$text}};
          
          \node[nodet,anchor=north] (comma) at ([xshift=\spacing/2, yshift=-\loopheight] first.south east) {,};
          
          \draw[arrow] (first) -- (ftext);
          \draw[arrow] (ftext) -- (last);
          \draw[arrow] (last) -- (ltext);
          \draw[arrow, rounded corners] (ftext.east) -- ++(\spacing/2,0em) |- ++(0em,-\loopheight) |- (comma.east);
...
\begin{inspiration}{Xander Harris\cite{buffy_s7e4}}
  ``
...
\begin{inspiration}{Donald Knuth\cite{knuth74ComputerProgrammingasanArt}}
  ``
...
\begin{inspiration}{Donald Knuth\cite{knuth1977notes}}
  ``
...
\begin{inspiration}{Brian Kernighan\cite{Kernighan1976SoftwareTools}}
  ``
...
\begin{inspiration}{John F. Woods\cite{woods_1991}}
  ``
