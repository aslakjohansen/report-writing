...
% the goal in the report is to capture a subset of these experiences that represent one -- or more -- units of knowledge that can be represented in a easility accessible way, the report tells the story behind these units of knowledge

% the story may not become clear before the end, may have to skip part of the experiences or effort, especially if effort is ot directed, should try to find a way of including it

% conclusion
That story starts out by posing a relevant question, and by working on that question -- through different phases -- takes a step towards a solution. It is rare that a perfect solution is achieved, but the reporting of the experiences throughout these phases at the very least should contribute to the body of experiences relating to this problem. Likely, you will make more tangible contributions.
