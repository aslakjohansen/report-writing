...
This approach translates well into a setup where experiment data across multiple runs are appended to a file. Simply add a new header before each experiment, and make sure you process the header comments as you go through the file. Then the most recent header will always be used to translate the file.
