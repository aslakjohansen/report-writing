...
% poster day
Every year, SDU hold the \quoted{TEK Software Day}\idx{TEK software day} event sometime in May. Software engineering students who are working on their BSc or MSc present their projects through one poster per group, a short pitch, and -- optionally -- a demo. In recent years there has been some variation in the format with regards to whether it is mandatory.
