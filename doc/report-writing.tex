...
% the good software engineer: taking into account resource needs (e.g., time, money), fallback to computer science, example (when no suitable -- ref to ALL requirements [current and future] -- framework can be found)
