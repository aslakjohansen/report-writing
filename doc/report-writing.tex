...
By now, you should have decided om a programming language paradigm, or at least have considered the different aspects. The next step is to choose a language that is a good match for this paradigm. Violating this is a common mistake.
...
Often, a group will choose Python as their main programming language. This is a scripting language that relies of tuples, lists and maps as the basic data structures. It wasn't designed for object-orientation in mind and thus does not have strong object-oriented properties. By forcing an object-oriented mindset they will likely end up with a poor mapping from concept to implementation. Instead they should have chosen a language whose strengths played to the intended paradigm.
