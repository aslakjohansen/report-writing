...
\begin{figure}
  ...
  \begin{tabular}{llccrr}
    \emph{Education} & \emph{Level} & \emph{ECTS} & \emph{Group} & \emph{Total Time} & \emph{Presentation Time} \\
     & & \emph{[ECTS]} & \emph{Size} & \emph{[min]} & \emph{[min]} \\
...
% based on learning objectives: clear pass -> verify, middle -> can we pull up? (expectation high), buttom -> can we pull up (expectation low)?
