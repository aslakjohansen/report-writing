...
Why do people bother to write reports? They do it to packetize contributions of insights into an easily consumable format. More text does not equal more contribution. While this is also the case for text quality, that text quality does affect how readily available those contributions are. The contributions come from the value that your insights bring. Your report is here as a media to carry these contributions. You should use this to anchor everything you place in your report.
...
\begin{itemize}
  \descitem{Problem identification} The contribution leads to the reader being aware of something that needs attention.
  \descitem{Problem analysis} The contribution brings new insights into an established problem.
  \descitem{Solution proposition} The contribution describes a way of dealing with an established problem and details the tradeoffs made.
\end{itemize}
