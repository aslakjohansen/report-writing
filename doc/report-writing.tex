...
The scoring function is never going to be perfect, and there is likely to be wa too many papers in the initial seeding alone to go through. So we need to define when we stop. This is the completion condition.
