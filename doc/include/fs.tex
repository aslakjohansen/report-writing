...
\tikzstyle{dedgehighlight} = [dedge,very thick]
\tikzstyle{node}=[
  overlay,
  circle,
  draw=purple,
...
\prgNewFunction \genFsI { m } {
  \prgPrint{
    \IfSubStr{#1}{highlight:abs}{
      \node[fill=purple!20,dirhighlight] (root1) at ([xshift=0cm, yshift=0cm] rootAnchor) {};
    }{
    ...
    \IfSubStr{#1}{highlight:abs}{
      \draw[dedgehighlight] (root1)--(root15);
    }{
    ...
    \IfSubStr{#1}{highlight:rel}{
      \draw[dedgehighlight] (root15)--(root151);
    }{
...
\prgNewFunction \genFsII { m } {
  \prgPrint{
    \IfSubStr{#1}{highlight}{
      \node[fill=purple!20, dirhighlight] (guest1) at ([xshift=0cm, yshift=0cm] guestAnchor) {};
    }{
    ...
    \IfSubStr{#1}{highlight}{
      \draw[dedgehighlight] (guest1)--(guest12);
    }{
...
\prgNewFunction \genMount { m } {
  \prgPrint{
    \IfSubStr{#1}{highlight}{
      \draw[dedgehighlight, dashed, draw=blue] (root151)--(guest1) node[midway,sloped,below] {\scalebox{0.7}{\textsl{\textcolor{blue}{mount}}}};
    }{
...
\prgNewFunction \genWD { m } {
  \prgPrint{
    \node[anchor=east] (cwd) at ([xshift=-1cm, yshift=0.0cm] root15) {\scalebox{0.7}{\textsl{\textcolor{purple!50!orange}{working directory}}}};
    \draw[dedgehighlight, draw=purple!50!orange] (cwd)--(root15);
  }
}
\IgnoreSpacesOff
