...
\begin{itemize}
  ...
  \descitem{Metadata} Covering:
    \begin{itemize}
      \descitem{Ownership} Who \textsl{owns} the file (e.g., for quota purposes).
      \descitem{Rights} For assigning users, or groups of users, rights to perform certain operations on the file (e.g., read, write and execute).
      \descitem{Timestamps} E.g., for creation, modification and access.
    \end{itemize}
\end{itemize}

% operating on: pointer, read & write number of characters, end-of-file, seeking
