...
% intro: Starting node, events and transitions, visually spotting problems, documenting protocol commands ("I need to gransition to this state before I can issue this command")
