  ...
  \rotatebox{90}{
    \begin{tikzpicture}[remember picture]
      ...
      % room 1
      {
        ...
        \point{room1t}{[xshift=-\roomdist*\diagside,yshift=-\roomdist*\diagside] room1}{thermocouple}{\degreeCelsius}{12}{17c5ae15}
        ...
        \node[modality] (room1humModality) at ($(room1)!0.5!(room1h point)$) {\modalitytext{relative humidity}};
      ...
      % room 2
      {
        ...
        \point[-1]{room2t}{[xshift=\roomdist*\diagside,yshift=-\roomdist*\diagside] room2}{thermistor}{\degreeCelsius}{16}{3b83ce7c}
        ...
        \node[modality] (room2humModality) at ($(room2)!0.5!(room2h point)$) {\modalitytext{relative humidity}};
