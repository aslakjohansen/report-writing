...
%        \draw[dedge] (#1 point) -- (data) node[midway,left,yshift=2mm] {\edgetext{data}};
      ...
      \point{room1t}{4-4*\diagside,4-4*\diagside}{Temp}{\degreeCelsius}{12}{17c5ae15}
      \point{room1h}{4,0}{Hum}{\percent}{13}{65d0be73}
      \point{room1o}{0,4}{PIR}{}{24}{5a3573c3}
      
      \node[room] (room1) at (4,4) {\nodetext{Room}};
