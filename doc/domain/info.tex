...
\begin{figure}[tbp]
  ...
  \end{center}
  \caption[Example of an abstract information model]{Example of an abstract information model. TM is an abbreviation for thermistor, and TC for thermocouple}
