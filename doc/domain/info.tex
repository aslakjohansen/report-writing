...
\begin{figure}[tbp]
  \begin{center}
    \begin{tikzpicture}[remember picture]
      ...
      % room 2
      {
        \node[room] (room2) at (1.5, 0) {\nodetext{Room}};
        \node[field] (room2area) at ([yshift=\datadist+4mm] room2.center) {\fieldtext{23 \si{\square\meter}}};
        \draw[dedge] (room2) -- (room2area) node[midway,sloped,above] {\edgetext{area}};
        
        \point{room2t}{[xshift=\roomdist*\diagside,yshift=-\roomdist*\diagside] room2}{Temp}{\degreeCelsius}{16}{3b83ce7c}
        \point{room2h}{[xshift=0,yshift=-\roomdist] room2}{Hum}{\percent}{53}{91729592}
        \point{room2o}{[xshift=\roomdist,yshift=0] room2}{PIR}{}{27}{b4ae871d}
        ...
        \node[modality] (room2humModality) at ($(room2)!0.5!(room2h point)$) {\modalitytext{humidity}};
      ...
      % middle
      {
        ...
        \node[room] (floor) at ([yshift=10mm] $(room1)!0.5!(room2)$) {\nodetext{Floor}};
        ...
        \node[field] (floorName) at ([yshift=\datadist+4mm] floor.center) {\fieldtext{3rd}};
