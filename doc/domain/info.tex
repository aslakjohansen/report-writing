...
\begin{figure}[tbp]
  ...
  \begin{subfigure}[b]{0.48\textwidth}
    ...
    \caption{Match sites of absolute humidity query.}
    \label{fig:topics:info:match:absolute}
  \end{subfigure}
  \hfill
  \begin{subfigure}[b]{0.48\textwidth}
    \rotatebox{90}{
    ...
    \caption{Match sites of occupancy query.}
    \label{fig:topics:info:match:occupancy}
  \end{subfigure}
  \\
  \begin{subfigure}[b]{0.48\textwidth}
    \rotatebox{90}{
