  ...
  \begin{center}
    \begin{tikzpicture}[remember picture]
      ...
      \newcommand{\point}[6]{
        ...
        \draw[dedge] (#1 point) -- (unit) node[midway,right,yshift=2mm] {unit};
        \draw[dedge] (#1 point) -- (data) node[midway,left,yshift=2mm] {data};
      }
%      \newcommand{\point}[6]{
%        \node[point] ({#1}point) at (#2) {#3};
%        \data{data}{[yshift=-4mm, xshift=-4mm-\pointsize/2] {#1}point.south}{#5}{#6};
...
%      }
      ...
      \draw[dedge] (room1) -- (room1tempModality) node[midway,right,yshift=-0.5mm] {modality};
      \draw[dedge] (room1t point) -- (room1tempModality) node[midway,right,yshift=-0.5mm] {provides};
      
      \node[modality] (room1humModality) at (5, 2) {\tiny{humidity}};
      \draw[dedge] (room1) -- (room1humModality) node[midway,right,yshift=-0.5mm] {modality};
      \draw[dedge] (room1h point) -- (room1humModality) node[midway,right,yshift=-0.5mm] {provides};
      
      \node[modality] (room1occModality) at (2.5, 4) {\tiny{occupancy}};
      \draw[dedge] (room1) -- (room1occModality) node[midway,right,yshift=-0.5mm] {modality};
      \draw[dedge] (room1p point) -- (room1occModality) node[midway,right,yshift=-0.5mm] {provides};
    \end{tikzpicture}
  \end{center}
