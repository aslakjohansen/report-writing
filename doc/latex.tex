...
\idx{Poster}There are a few options for creating posters in \LaTeX. I am currently using the \texttt{tikzposter} package\idxx{tikzposter package@\texttt{tikzposter} package}{\texttt{tikzposter} package}. An example can be found here: \url{https://github.com/aslakjohansen/poster-sample/}
